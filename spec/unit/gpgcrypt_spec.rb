...
describe GpgCrypt do
  ...
  it "should convert ssh keys into openssl keys" do
    #GpgCrypt.convert_openssh_public_key_to_openssl()
  end
  ...
  it "should be able to determine whether it should encrypt or decrypt something" do
    ...
    #GpgCrypt.get_key_type?(@priv_key).should eq :private
    #GpgCrypt.get_key_type?("@priv_key").should eq :incompatible
  end
end